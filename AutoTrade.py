...
post_message(myToken,"#투자", "autotrade start")
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if target_price < current_price and current_price < predicted_close_price:
                ...
                if krw > 5000:
                    ...
                    post_message(myToken, "#투자", "BTC buy : " + str(buy_result))
        else:
            btc = get_balance("BTC")
            if btc > 0.00008:
                upbit.sell_market_order("KRW-BTC", btc*0.9995)
                post_message(myToken, "#투자", "BTC buy : " + str(sell_result))
        time.sleep(1)
    except Exception as e:
        print(e)
        post_message(myToken, "#xn자", ㄷ)
        time.sleep(1)